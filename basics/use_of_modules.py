...
# Using sys module
# Cmd command 1 - python use_of_modules.py
# Cmd command 2 - python use_of_modules.py "Gopi" 23
arguments_list_via_cmd = sys.argv   # Stores the list of command line arguments
print(arguments_list_via_cmd)   # Cmd Command 1 - Prints ["use_of_modules.py"]
                                # Cmd Command 2 - Prints ["use_of_modules.py", "Gopi", "23"]
